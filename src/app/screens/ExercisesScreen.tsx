...
const exercises = [
  ...
  { id: "7", title: "Sprint Intervals", category: "HIIT", bodyPart: "Cardio", duration: "40 min", calories: 580, intensity: "High", level: "Advanced", isPremium: true, img: "https://images.unsplash.com/photo-1604011237535-628ea8a45753?w=400&q=80" },
  ...
  { id: "9", title: "Shoulder Press Pro", category: "Strength", bodyPart: "Shoulders", duration: "42 min", calories: 310, intensity: "Medium", level: "Advanced", isPremium: true, img: "https://images.unsplash.com/photo-1605296867724-fa87a8ef53fd?w=400&q=80" },
  { id: "10", title: "Back Sculpt", category: "Strength", bodyPart: "Back", duration: "48 min", calories: 380, intensity: "Medium", level: "Intermediate", isPremium: false, img: "https://images.unsplash.com/photo-1597376833295-40a54d5e69fc?w=400&q=80" },
  { id: "11", title: "Arm Blaster", category: "Strength", bodyPart: "Arms", duration: "30 min", calories: 220, intensity: "Medium", level: "Beginner", isPremium: false, img: "https://images.unsplash.com/photo-1638820870229-00003edce192?w=400&q=80" },
  { id: "12", title: "Elite Chest Program", category: "Strength", bodyPart: "Chest", duration: "55 min", calories: 460, intensity: "High", level: "Advanced", isPremium: true, img: "https://images.unsplash.com/photo-1605296867724-fa87a8ef53fd?w=400&q=80" },
];
