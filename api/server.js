...
// ── In-memory store (Vercel serverless — no SQLite) ───────────────────────
// NOTE: Data is ephemeral per serverless instance. For production persistence,
// replace this with a cloud DB such as Neon (Postgres) or PlanetScale (MySQL).
